...
export function DataTable<TData>({
  ...
  return (
    <div className="space-y-4">
      <div className={tableWrapperClassName ?? "overflow-hidden border-b"}>
        <Table className={tableClassName}>
          <TableHeader
            className={headerClassName ?? "sticky font-bold top-0 z-10"}
          >
            ...
            {isPending ? (
                ...
                >
                  {row.getVisibleCells().map((cell) => (
                    <TableCell
                      key={cell.id}
                      className={
                        typeof bodyCellClassName === "function"
              ...
              <TableRow>
                <TableCell
                  ...
                  className={emptyStateClassName ?? "h-24 text-center"}
                >
                  No results found.
                </TableCell>
              </TableRow>
